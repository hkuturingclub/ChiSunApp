      ...
      <Form onSubmit={handleSubmit}>
        <FormGroup>
          ...
          <Input
            ...
            value={values.name}
          />
          {errors.name && touched.name && <FormText color="danger">{errors.name}</FormText>}
        </FormGroup>
        <FormGroup>
          ...
          />
          {errors.description
            && touched.description && <FormText color="danger">{errors.description}</FormText>}
        </FormGroup>
        <Row>
          <Col>
            <FormGroup>
              ...
              />
              {errors.location
                && touched.location && <FormText color="danger">{errors.location}</FormText>}
            </FormGroup>
          </Col>
          <Col>
            <FormGroup>
              ...
              />
              {errors.startDate
                && touched.startDate && <FormText color="danger">{errors.startDate}</FormText>}
            </FormGroup>
          </Col>
        </Row>
        <FormGroup>
          ...
          <Input
            ...
            onBlur={handleBlur}
          />
          {errors.image && touched.image && <FormText color="danger">{errors.image}</FormText>}
        </FormGroup>
