...
const SidebarFooter = () => (
  <View style={styles.footer}>
    <View style={styles.socialContainer}>
      ...
      <TouchableOpacity
        onPress={() => openLink("https://www.facebook.com/chisuncollege/")}
      >
        <Icon
      ...
      <TouchableOpacity
        onPress={() =>
          openLink("https://www.instagram.com/chisuncollege/?hl=en")
        }
      >
        <Icon
          style={styles.iconContainer}
    ...
    <TouchableOpacity
      ...
      onPress={() => openLink("mailto:turingclub.hku@gmail.com")}
    >
    ...
    <TouchableOpacity
      ...
      onPress={() =>
        WebBrowser.openBrowserAsync(
          "https://hkuturingclub.github.io/ChiSunApp/privacy-policy/app"
        )
      }
    >
      <Text style={{ ...styles.footerText, textDecorationLine: "underline" }}>
