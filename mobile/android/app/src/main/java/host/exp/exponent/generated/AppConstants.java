...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@turingclub/hku-chi-sun-college";
  public static final String SHELL_APP_SCHEME = "exp4a70b9d821554259b537a8c86df9dc78";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@turingclub/hku-chi-sun-college", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40turingclub%2Fhku-chi-sun-college%2F1.0.0%2Fa18f55af11a1e0c5d8a2d3fff13c52c3-34.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
