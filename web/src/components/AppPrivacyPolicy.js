...
const AppPrivacyPolicy = () => (
  <div>
    ...
    <p>
      {" "}
      HKU Turing Club built the CSC (Chi Sun College) app as an Open Source app.
      This SERVICE is provided by HKU Turing Club at no cost and is intended for
      use as is.
    </p>{" "}
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at CSC (Chi Sun College) unless
    ...
    <p>
      ...
      <a href="mailto:turingclub.hku@gmail.com">turingclub.hku@gmail.com</a>.
    </p>{" "}
    <p>
